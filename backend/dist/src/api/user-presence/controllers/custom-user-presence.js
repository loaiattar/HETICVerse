...
exports.default = {
    ...
    updatePresence: async (ctx) => {
        ...
        try {
            ...
            const existingPresence = await strapi.db
            ...
            if (existingPresence) {
                ...
                const updatedPresence = await strapi.entityService.update('api::user-presence.user-presence', existingPresence.id, {
                    data: {
                ...
                const newPresence = await strapi.entityService.create('api::user-presence.user-presence', {
                    data: {
                        user: user.id,
