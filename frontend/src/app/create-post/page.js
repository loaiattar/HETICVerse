    ...
    <div className="flex min-h-screen bg-[#121212]">
      ...
      <div className="flex-1">
        ...
        <div className='flex justify-center w-full'>
            ...
            {activeComponent === 'text' && <PostTextForm onPostCreated={() => router.push('/home')} />}
            {activeComponent === 'media' && <UploadMedia onPostCreated={() => router.push('/home')} />}
            {activeComponent === 'link' && <PostLinkForm onPostCreated={() => router.push('/home')} />}
